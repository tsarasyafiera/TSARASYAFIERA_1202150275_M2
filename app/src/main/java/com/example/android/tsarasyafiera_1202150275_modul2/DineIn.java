...
import static com.example.android.tsarasyafiera_1202150275_modul2.R.id.spinner_table;
...
public class DineIn extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create the spinner.
       spinner = findViewById(spinner_table);

        // Create ArrayAdapter using the string array and default spinner layout.
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.tabels_array, android.R.layout.simple_spinner_item);
