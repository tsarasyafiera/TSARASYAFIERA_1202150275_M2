...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.MenuViewHolder>{
    ...
    public RecycleViewAdapter (Context context, LinkedList<String> foodList, LinkedList<Integer> priceList, LinkedList<Integer> photoList) {
            ...
            public MenuViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View mItemView = mInflater.inflate(R.layout.activity_recycle_view_adapter, parent, false);
            ...
            class MenuViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
                ...
                public MenuViewHolder(final View itemView, RecycleViewAdapter adapter) {
                    super(itemView);
                    ...
                    photoItemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Intent intent = new Intent(itemView.getContext(), com.example.android.tsarasyafiera_1202150275_modul2.DetailMenu.class);
